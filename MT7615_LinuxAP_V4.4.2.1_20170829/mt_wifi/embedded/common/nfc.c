...
/*
	...
	Vendor: 0x14C3
	Action: bḂḊ<7:6>: 0x0 ḂV To NFC, 0x1 ḂV From NFC
	        bḂḊ<5:0>: 0x00 ḂV Get, 0x01 - Set
	Type:	
...
INT Set_NfcStatus_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
	...
	/*
		Action: bḂḊ<7:6>: 0x00 - Request, 0x01 - Notify
        		bḂḊ<5:0>: 0x00 - Get, 0x01 - Set
	*/
...
INT Get_NfcStatus_Proc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
 	UCHAR data = 0;
	/*
		Action: bḂḊ<7:6>: 0x0 - To NFC, 0x1 - From NFC
        		bḂḊ<5:0>: 0x0 - Get, 0x01 - Set
	*/
